		...
		<section class="cart bgwhite p-t-70 p-b-100">
			...
			<div class='container'>
				...
				if (creationPanier())
				{
					...
					if ($nbArticles <= 0)
					{
						echo "<tr class='table-head'><td style='padding-left: 60px;'>Votre panier est vide </td>";
					...
					else
					{
						...
						echo '<th class="column-1">Photo</th>';
						echo '<th class="column-2">Libellé</th>';
						echo '<th  class="column-3">Quantité</th>';
						echo '<th class="column-4">Prix Unitaire</th>';
						...
						echo "<input type='button' style='padding: 0 15px 0 15px; margin: 15% 0 0 60%;' class='flex-c-m bg1 bo-rad-23 hov1 s-text1 trans-0-4' type=\"submit\" value=\"Rafraichir\"/>";
					}
					echo "</table>";
					echo "</div>";
				}
